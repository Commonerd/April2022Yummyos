...
<body>
     ...
     <div class="container" align="center">
      <div class="row">
         <form method="post" id="updateform" action="store/update/store/update" enctype="multipart/form-data">
         <input type="hidden" name="_method" value="put">
            <table class="table table-striped"
               ...
               <thead>
                  <tr>
                     <th colspan="2"
                        style="background-color: #eeeeee; text-align: center;">식당 정보를 수정해 주세요.</th>
                  </tr>
               </thead>
               <tbody>
                  <tr>
                  		<td><input type="text" class="form-control" placeholder="상호명" name="title" maxlength="50" style="width: 1000px" value="${dto.name }" /></td>                  		
                  </tr>
                  <tr>
                  		<td><input type="text" class="form-control" placeholder="상점번호" name="no" maxlength="50" style="width: 1000px" value="${dto.no}" type="hidden" /></td>                  		
                  </tr>
                  <tr>
                  		<td><input type="text" class="form-control" placeholder="테마" name="category" maxlength="50" style="width: 1000px" value="${dto.category}" /></td>                  		
                  </tr>
                  <tr>
                  		<td><input type="text" class="form-control" placeholder="전화번호" name="phone" maxlength="50" style="width: 1000px" value="${dto.phone}" /></td>                  		
                  </tr>
                  <tr>
                  		<td><input type="text" class="form-control" placeholder="주소" name="address" id="address" maxlength="50" style="width: 1000px" value="${dto.address}" />
                  			<input type="button" id="addbtn" value="주소 검색" onclick="addPost()"></td></tr>
                  <tr>
                  		<td><input type="text" class="form-control" placeholder="해시태그" name="hashtag" maxlength="50" style="width: 1000px" value="${dto.hashtag}" /></td>                  		
                  </tr>
                  <tr>
                  		<td><input type="file" class="form-control" placeholder="대표이미지" name="files" maxlength="50" style="width: 1000px" value="${dto.image}" /></td>                  		
                  </tr>                  
                  <tr>                  
                     <td>
                     </td>
                  ...
                  <tr>
                     <td><div id="smarteditor">
                           <textarea name="category" id="editorTxt" rows="20" cols="10" placeholder="내용을 입력해주세요" style="width: 1000px"></textarea>
                        </div></td>
                  </tr>
               </tbody>
            </table>
            <br> 작성자 : <input name="id" value="${user.id }" readonly>
            <input type="button" id="save" value="수정 등록">
