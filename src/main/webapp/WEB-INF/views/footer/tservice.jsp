  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
   ...
   <form class="form-inline my-2 my-lg-0" action="/all/search">
      <c:forEach items="${search}" var="search">
         ...
         <br>
         <input name="search" id="search" type="search" style="width: 500px;" class="form-control mr-sm-2" placeholder="원하시는 메뉴를 입력해주세요" aria-label="Search">
...
<li>
 <a href="loginform" id="login" class="btn btn-primary" style="width:100px; height:40px;">로그인</a>
 <a href="/insert" id="join" class="btn btn-primary" style="width:120px; height:40px;">회원가입</a>
</ul>
  </div>
</nav>
<div class="container-fluid con" >
<h1>이용 약관</h1>
<h3><3조 yummyo 이용약관></h3>

    <h4>제 1장 총칙</h4>
        
      <h5>제 1조 (목적)</h5>
      <p>서비스 이용 약관(이하 ‘약관’이라 함)은 야미요 주식회사(이하 '회사'라 함)가 제공하는 야미요, 야미요Plus 등을 포함한야미요에서 제공하는 서비스 (이하 ‘서비스’)를 이용함에 있어 ‘회사’와 ‘회원’(제 2조에서 정의합니다)의 권리, 의무, 책임사항 및 ‘회원’의 ‘서비스’이용절차에 관한 사항을 규정함을 목적으로 합니다. ‘서비스’의 제공 방식에 따라 별도로 회원가입을 했더라도 ‘회원’은 ‘회사’에서 운영하는 ‘서비스’에 추가 약관 동의 없이 이용 할 수 있습니다.</p>

      <h5>제 2 조 (용어의정의)</h5>
      <p>1. ‘서비스’라 함은 구현되는 단말기 (PC, 휴대형단말기 등의 각종 유무선장치를 포함)와 상관없이 ‘회사’에 종속되어 ‘회원’을 대상으로 제공하는 모든 기능을 의미합니다.</p>
      <p>
        1) 야미요 서비스<br />
        ① 야미요 서비스(이하 ‘야미요’이라 함) : 위치 기반으로 전세계 맛집을 추천 받거나 검색 하고 방문기록을 남기는 서비스 입니다.<br />
        ② 야미요매장 : ‘야미요매장’이란 ‘야미요’를 통해 정보를 제공하는 모든 음식점 및 술집 등을 지칭합니다.<br />
        ③ 야미요리뷰 : ‘회원’이 야미요 상에서 ‘매장’에 직접 남긴 평가점수, 글, 사진, 동영상을 의미합니다.<br />
      </p>                              
      <p>
        2) 야미요Plus 서비스<br />
        ① 야미요Plus 서비스(이하 ‘야미요Plus’라 함) : ‘회원’이 원하는 모임이나 서비스 조건을 요청하고, 야미요Plus 가맹점에서 할인, 서비스 혜택을 제안하여 예약 및 예약금을 결제하는 프리미엄 예약 서비스 입니다.<br />
        ② 야미요Plus 매장 : ‘야미요Plus 매장’이란 서비스 상에서 ‘야미요Plus’를 통해 정보를 제공하는 모든 음식점 및 술집 등을 지칭합니다.<br />
        ③ 야미요Plus 리뷰 : ‘회원’이 야미요Plus 상에서 ‘매장’에 직접 남긴 평가점수, 글, 사진, 동영상을 의미합니다.<br /> 
      </p>
      <p>
      ...
      <p>
        1) 야미요<br />
        ① ‘야미요매장’에 대해 고의적으로 악성 리뷰를 남기는 행위<br />
      ...
      <h5>제 10조(야미요, 야미요Plus 서비스의 예약 정책)</h5>
      <p>1. ‘야미요’과 ‘야미요Plus’는 예약 서비스를 제공합니다.</p>
      <p>
        1) 야미요<br />
        ① ‘야미요’ 간편 예약은 비로그인 기반 서비스로서 서비스에 가입한 회원이 아니더라도 이용 가능합니다. (단, 간편 예약 요청 시 예약자 정보(이름, 휴대폰번호)를 입력한 사용자에 한해 이용 가능하며, 예약자 정보를 입력한 사용자를 ‘회원’ 이라고 칭하며, 예약 서비스에 한해서만 그 권한을 부여한다.<br />
        ② ‘회사’는 ‘회원’이 예약을 요청할 때, ‘야미요매장’에 ‘회원’의 개인정보 및 예약정보를 전달하고 ‘야미요매장’의 응답에 따라 ‘회원’에게 예약 결과를 전달하는 중개자 역할을 합니다.<br />
        ③ ‘야미요매장’의 상황에 따라 ‘회원’이 요청한 예약에 대한 응답이 지연되거나, ‘야미요매장’의 영업시간이 종료된 경우 해당 내용을 ‘회원’에게 미리 공지(예. 문자/전화)합니다.<br />
        ...
        ⑦ ‘회원’이 요청한 예약의 확정 여부는 전적으로 ‘야미요매장’에서 결정하며, ‘야미요매장’ 상황에 따라 취소 또는 변경될 수 있으며, ‘회사’에서 결정한 방식에 따라 ‘회원’에게 그 내용을 공지합니다. 단, ‘야미요매장’에서 ‘회원’에게 개별적으로 연락을 취한 경우에 대해서는 별도로 공지하지 않습니다.<br /> 
        ⑧ ‘회원’이 다음 각 사항들을 지키지 않을 시 불이익이 발생할 수 있으며 이에 대한 모든 책임은 회원에게 있습니다. • ‘회원’이 예약 요청 시 선택한 인원 수에 맞춰 예약된 ‘야미요매장’에 방문 • ‘회원’이 예약 요청 시 선택한 날짜에 맞춰 예약된 ‘야미요매장’에 방문 • ‘회원’이 예약 요청 시 선택한 시간에 맞춰 예약된 ‘야미요매장’에 방문
      </p>
      <p>
        2) 야미요Plus<br />
        ① ‘회사’는 ‘회원’이 입력한 요청 내용에 적절한 하나 또는 2개 이상의 ‘야미요Plus 매장’의 메뉴 및 혜택을 제안하고 ‘회원’이 선택한 ‘야미요Plus 매장’ 예약에 따라 ‘야미요Plus 매장’에 예약 결과와 제시한 혜택을 전달하는 중간자 역할을 합니다.<br />
        ② ‘회사’의 영업시간(오전 9시 30분 ~ 오후 6시 30분) 외에 들어온 요청 건은 익일 영업시간에 처리되며, 영업시간 내에 들어온 요청 건은 요청이 들어온 당일에 처리됩니다.<br />
        ③ ‘회원’이 입력한 요청에 대하여 ‘회사’가 제안할 ‘야미요Plus 매장’이 없을 경우, ‘회사’는 ‘회원’에게 요청일 내에 이를 유선상으로 통지합니다.<br />
        ④ ‘회사’가 제안한 내용에 대하여 ‘회원’이 방문일 2일 전 오후 6시까지 예약하지 않을 경우, 요청은 종료 처리됩니다.<br />
        ⑤ ‘회원’의 요청 건에 대하여 ‘야미요Plus 매장’에서 제안하는 내용은 ‘야미요Plus 매장’에서 결정하며 ‘회사’는 그 어떤 개입도 없이 전달만 수행합니다. ‘야미요Plus 매장’의 제안 내용은 유사한 조건의 요청이더라도 ‘야미요Plus 매장’의 상황에 따라 달라질 수 있습니다.<br />
        ⑥ ‘회원’이 예약한 ‘야미요Plus 매장’에 예약을 전달하거나 예기치 못한 상황으로 인해 연락이 필요한 경우, ‘서비스’에 가입되어 있는 ‘회원’의 휴대폰번호를 기준으로 처리되며, ‘회원’의 휴대폰번호 변경 등의 사유로 연락이 되지 않을 경우 ‘회원’에게 발생하는 불이익에 대해서 ‘회사’는 책임지지 않습니다.<br />
        ⑦ ‘회사’는 예약금이 있는 ‘야미요Plus 매장’에 대한 예약에 한하여 ‘예약금제도’를 운영할 수 있으며, 이 경우 ‘회원’은 예약 시 안내되는 예약금을 결제해야만 예약이 완료됩니다.<br />
        ⑧ ‘회원’이 다음 각 사항들을 지키지 않을 시 불이익이 발생할 수 있으며 이에 대한 모든 책임은 회원에게 있습니다.<br />
        • ‘회원’이 예약 요청 시 선택한 인원 수에 맞춰 예약된 ‘야미요Plus 매장’에 방문<br />
        • ‘회원’이 예약 요청 시 선택한 날짜에 맞춰 예약된 ‘야미요Plus 매장’에 방문<br />
        • ‘회원’이 예약 요청 시 선택한 시간에 맞춰 예약된 ‘야미요Plus 매장’에 방문
      </p>

      <h5>제 11조 (예약금 제도의 운영)</h5>
      <p>‘회사’는 제10조 야미요Plus 제7항과 같이 예약금이 있는 ‘야미요Plus 매장’ 예약 건에 한하여 ‘예약금’ 제도를 운영할 수 있으며, 아래의 약관에 따라 운영됩니다.</p>

      <p>
        1. ‘야미요Plus 매장’이 설정 가능한 ‘예약금’의 종류는 ‘20%, 50%, 100%, 없음’ 의 4가지 경우입니다.<br />
        2. ‘회원’이 ‘예약금’이 있는 ‘야미요Plus 매장’에 예약 시 정해진 금액의 ‘예약금’을 결제할 것을 요청합니다.<br />
        3. ‘예약금’ 결제가 완료되면 예약이 확정됩니다.<br />
        4. 결제한 ‘예약금’을 제외한 나머지 금액은 예약 당일 ‘회원’이 ‘야미요Plus 매장’에 방문하여 ‘서비스’를 이용한 이후 계산합니다.<br />
      ...
      <p>
        ...
        [7차 변경] 2016년 7월 4일 변경사유 : 찾아줘 서비스 야미요Plus로 명칭 변경에 따른 수정<br />
