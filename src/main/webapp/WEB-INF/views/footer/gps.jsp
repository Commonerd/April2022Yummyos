...
<p>본 약관은 회원(야미요 서비스 약관에 동의한 자를 말합니다. 이하 &quot;회원&quot;이라고 합니다)이 주식회사 야미요컴퍼니(이하 &quot;회사&quot;라고 합니다.)가 제공하는 야미요 서비스(이하 &quot;서비스&quot;라고 합니다)를 이용함에 있어 회사와 회원의 권리&middot;의무 및 책임사항을 규정함을 목적으로 합니다.</p>
...
<p>③ 회사는 위치정보의 보호 및 이용 등에 관한 법률, 콘텐츠산업 진흥법, 전자상거래 등에서의 소비자보호에 관한 법률, 소비자 기본법 약관의 규제에 관한 법률 등 관련법령을 위배하지 않는 범위에서 본 약관을 개정할 수 있습니다.</p>
...
<p>⑤ 회사가 전항에 따라 회원에게 통지하면서 공지 또는 공지ㆍ고지일로부터 개정약관 시행일 7일 후까지 거부의사를 표시하지 아니하면 이용약관에 승인한 것으로 봅니다. 회원이 개정약관에 동의하지 않을 경우 회원은 이용계약을 해지할 수 있습니다.</p>

<p>제 3 조 (관계법령의 적용) 본 약관은 신의성실의 원칙에 따라 공정하게 적용하며, 본 약관에 명시되지 아니한 사항에 대하여는 관계법령 또는 상관례에 따릅니다.</p>

<p>제 4 조 (서비스의 내용) 회사가 제공하는 서비스는 아래와 같습니다.</p>

<p>서비스 명 야미요</p>

<p>서비스 내용 모바일용 어플리케이션, PC용 웹사이트</p>
...
<p>③ 회사는 타사업자 또는 이용 고객과의 요금정산 및 민원처리를 위해 위치정보 이용&middot;제공, 사실 확인자료를 자동 기록&middot;보존하며, 해당 자료는 1년간 보관합니다.</p>

<p>④ 회사는 개인위치정보를 회원이 지정하는 제3자에게 제공하는 경우에는 개인위치정보를 수집한 당해 통신 단말장치로 매회 회원 에게 제공받는 자, 제공 일시 및 제공목적을 즉시 통보합니다. 단, 아래 각 호의 1에 해당하는 경우에는 회원이 미리 특정하여 지정한 통신 단말장치 또는 전자우편주소로 통보합니다.</p>
...
<p>① 회사는 아래의 경우에 해당하는 자(이하 &ldquo;8세 이하의 아동&rdquo;등이라 한다)의 보호의무자가 8세 이하의 아동 등의 생명 또는 신체보호를 위하여 개인위치정보의 이용 또는 제공에 동의하는 경우에는 본인의 동의가 있는 것으로 봅니다.</p>
...
<p>제 12조 (위치정보관리책임자의 지정)</p>

<p>① 회사는 위치정보를 적절히 관리&middot;보호하고 개인위치정보주체의 불만을 원활히 처리할 수 있도록 실질적인 책임을 질 수 있는 지위에 있는 자를 위치정보관리책임자로 지정해 운영합니다.</p>
...
<p>제 17 조 (회사의 연락처) 회사의 상호 및 주소 등은 다음과 같습니다.</p>

<p>1. 상호 : 주식회사 야미요컴퍼니</p>

<p>2. 대표자 : 송영화</p>

<p>3. 주소 : 서울특별시 강남구 봉은사로 479, 479타워 11층</p>

<p>4. 대표전화 : 02-565-5988</p>

<p>부 칙</p>

<p>제1조 (시행일) 이 약관은 2015년 3월 16일 부터 시행합니다.</p>

<p>제2조 위치정보관리책임자는 2015년 3월 16일 을 기준으로 다음과 같이 지정합니다.</p>

<p>1. 소속 : 솔데스크 504 3조</p>

<p>2. 이름: 최지훈</p>

<p>3. 연락처 : 00-000-0000</p>
</div>
	<div class="container">
