...
<body>
	...
	<div class="container" align="center">
		<div class="row">
			...
			<form method="post" id="updateform" action="/board/notice/update">
				<input type="hidden" name="_method" value="put">
				<table class="table table-striped"
					style="text-align: center; float: center; width: 1000px; border: 1px solid #dddddd">
					<thead>
						<tr>
							<th colspan="2"
								style="background-color: #eeeeee; text-align: center;">공지사항을 수정해주세요.
								</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td><input name="title" value="${dto.title }" /> <input
								name="no" value="${dto.no}" type="hidden"
