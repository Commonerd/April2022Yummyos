			...
			<form method="post" id="writeform" action="write"
				...
				<table class="table table-striped"
					...
					<thead>
						<tr>
							<th colspan="2"
								style="background-color: #eeeeee; text-align: center;">푸드스토리를
								작성해주세요</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td><input type="text" class="form-control" 
								...
								style="width: 1000px; height : 50px; font-size : 1.5em" /></td>
						</tr>
						<tr align="left">
						...
						<tr>
							<td><div id="smarteditor">
									<textarea name="content" id="editorTxt" rows="20" cols="10"
										placeholder="내용을 입력해주세요" style="width: 1000px">
									</textarea>	
								</div></td>
						</tr>
					</tbody>
