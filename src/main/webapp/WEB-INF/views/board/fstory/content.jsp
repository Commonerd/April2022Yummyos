						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
							...
							<c:if test="${ user.role == 'role_admin'}">
								<li><a class="dropdown-item"
									href="/board/fstory/update/${dto.no}">글 수정</a></li>
								<li><a class="dropdown-item" id="${dto.no}" href="#">글
										삭제</a></li>
...
--%>
	...
	<div class="review">
		<h3>댓글</h3>
		<hr>
		<textarea name="content" id="content" cols="100"
