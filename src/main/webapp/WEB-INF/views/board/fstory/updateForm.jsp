	...
	<div class="container" align="center">
		<div class="row">
			...
			<input type="hidden" name="_method" value="put">
				<table class="table table-striped" style="text-align: center; float: center; width: 700px; border: 1px solid #dddddd">
					<thead>
						<tr>
							<th colspan="2"
								style="background-color: #eeeeee; text-align: center;">푸드스토리 수정</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td><input type="text" class="form-control" value="${dto.title }" 
								 name="Title" maxlength="50" style="width: 1000px; height : 50px; font-size : 1.5em" /> 
								<input name="no" value="${dto.no}" type="hidden"></td>
						</tr>
						<tr align="left">
				...
				<input type="button" id="save" value="수정 완료">
