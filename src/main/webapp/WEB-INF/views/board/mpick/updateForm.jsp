...
<body>
     ...
     <div class="container" align="center">
      <div class="row">
         <form method="post" id="updateform" action="/board/mpick/update" enctype="multipart/form-data">
         <input type="hidden" name="_method" value="put">
            <table class="table table-striped"
               ...
               <tbody>
                  <tr>
                  		<td><input type="text" class="form-control" placeholder="글 제목" name="title" maxlength="50" style="width: 1000px" value="${dto.title }" /></td>                  		
                  </tr>
                  <tr align="left">
                     <td>
                     </td>
                  ...
                  <tr>
                     <td><div id="smarteditor">
                           <textarea name="content" id="editorTxt" rows="20" cols="10" placeholder="내용을 입력해주세요" style="width: 1000px"></textarea>
                        </div></td>
                  </tr>
               </tbody>
            </table>
...
<%-- <form method="post" id="updateform" action="/board/mpick/update" >
<input type="hidden" name="_method" value="put">
	<table border="1">
		<tr>	
		...
		<tr>
			...
			<td><input name="stitle" value="${dto.stitle }"/>
			<input name="stitle" value="${dto.stitle}" type="hidden"> 
		</tr>		
		<tr>
