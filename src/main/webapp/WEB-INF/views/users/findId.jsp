    ...
    <div class="inner_login">
        <div class="login_tistory">
            <form method="post" class="form-signin" action="findId" name="findform">
                <fieldset>
                    <p>아이디 찾기</p>
                    <legend class="screen_out">아이디 찾기 입력폼</legend>
                    <div class="box_login">
                        <div class="inp_text">
                            <label for="birth" class="screen_out">생년월일</label>
                            <input type="text" id="birth" name="birth" class="form-control" placeholder="생년월일 입력 ex) 19900101"/>
                        </div>
                        <div class="inp_text">
                            <label for="email" class="screen_out">이메일주소</label>
